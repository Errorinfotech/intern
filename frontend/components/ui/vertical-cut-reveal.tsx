      ...
      >
        ...
        {(splitBy === "characters"
          ...
          const previousCharsCount = array
            .slice(0, wordIndex)
            .reduce((sum, word) => sum + (word as any).characters.length, 0)

          return (
            <span
              key={wordIndex}
              aria-hidden="true"
              className={cn("inline-flex overflow-hidden pb-4 -mb-4", wordLevelClassName)}
            >
              ...
              {(wordObj as any).needsSpace && <span> </span>}
            </span>
          )
        })}
      </span>
